    ...
    <HashRouter>
      <div className="min-h-screen flex flex-col items-center justify-center bg-indigo-800/80">
        ...
        <InstantSearch searchClient={searchClient} indexName={algoliaIndex}>
           {/* Con lg:hidden lo oculto en pantallas grandes*/}
        <div className="drawer lg:hidden ">
          <input id="my-drawer-1" type="checkbox" className="drawer-toggle" />
          <div className="drawer-content">
            {/* Page content here */}
            <label htmlFor="my-drawer-1" className="btn drawer-button fixed ">
              Open drawer
            </label>
          </div>
          <div className="drawer-side">
            ...
            <ul className="menu bg-base-200 min-h-full w-80 p-4">
              ...
              <li>
                <a><p>Marca</p>
                <ToggleFilterWithSearchBox attribute="brand" limit={50} /></a>
              </li>
              <li>
                <a>Sidebar Item 2</a>
              </li>
