    ...
    <ProductNavbar title={product.title} totalStock={totalStock} />
        ...
        <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row gap-6 mt-6">
                ...
                {/* Panel lateral */}
                <div className="bg-white shadow-lg rounded p-4 w-full md:w-64 h-fit">
                    <p className="text-lg font-bold">
                        Precio total: ₡{product.price.toLocaleString("es-CR")} 
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-200 p-4 rounded mt-6">
                <p className="col-span-1 md:col-span-2 font-bold">Información básica</p>
                <p>
