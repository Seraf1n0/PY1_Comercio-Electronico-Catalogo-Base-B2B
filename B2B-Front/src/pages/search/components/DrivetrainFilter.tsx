...
export default function DrivetrainFilter() {
  const { items, refine } = useMenu({ attribute: "facets.drivetrain", limit: 50 }); // El atributo es fijo. El limite está colocado en 50 para que muestre todas.
